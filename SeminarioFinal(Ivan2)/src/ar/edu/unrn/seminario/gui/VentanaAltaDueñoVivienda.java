			...
			public void actionPerformed(ActionEvent e) { // Registro a BD
				try {
					...
					api.registrarDueñoVivienda(textFieldNombre.getText(), textFieldApellido.getText(),
							Integer.parseInt(textFieldDNI.getText()), textFieldCalle.getText(), textFieldBarrio.getText(),
					...
					JOptionPane.showMessageDialog(null, "Verificar campos numericos", "Error",
