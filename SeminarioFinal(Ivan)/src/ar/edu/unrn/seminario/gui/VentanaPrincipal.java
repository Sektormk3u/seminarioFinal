...
public class VentanaPrincipal extends JFrame {
	...
	public VentanaPrincipal(IApi api) {
		...
		menuUsuarios.add(listarViviendas);
		...
		listarViviendas.addActionListener(new ActionListener() {
			...
			@Override
			public void actionPerformed(ActionEvent e) {
				VentanaListarViviendas ventanaListarViviendas;
				try {
					ventanaListarViviendas = new VentanaListarViviendas(api);
					ventanaListarViviendas.setVisible(true);
				} catch (CamposErroneos | CamposVacios e1) {
